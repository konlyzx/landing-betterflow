...
export default function CTAMobile() {
  return (
    <section className="relative z-10 overflow-hidden px-4 py-16">
      <div
        className="pointer-events-none absolute inset-0 flex justify-between px-4"
      ...
      >
        <h2
          className="mb-4 text-2xl leading-[1.15] font-semibold tracking-tight text-white"
        ...
        <p className="mx-auto mb-6 max-w-[320px] text-xs leading-relaxed text-[#71717a]">
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          ...
          <motion.a
            ...
            className="group inline-flex items-center justify-center gap-2 rounded-lg bg-[linear-gradient(135deg,#ff7e40_0%,#ff4b72_50%,#a445ff_100%)] px-4 py-2 text-xs font-medium text-white shadow-[0_4px_24px_rgba(164,69,255,0.25),inset_0_1px_0_rgba(255,255,255,0.2)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_6px_32px_rgba(164,69,255,0.35)] hover:brightness-110"
        ...
        <p className="mt-6 text-[10px] tracking-wide text-[#3f3f46]">
