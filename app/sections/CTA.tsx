...
export default function CTA() {
  return (
    <section className="relative z-10 px-6 py-32 overflow-hidden">
      ...
      >
        <h2
          className="text-4xl md:text-[56px] font-semibold text-white mb-6 tracking-tight leading-[1.08]"
        ...
        <p className="text-sm md:text-base text-[#71717a] mb-10 max-w-[460px] mx-auto leading-relaxed">
          Open source screenshot studio. No telemetry, no sign-up, no server
          roundtrips. Just beautiful visuals.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          ...
          <motion.a
            ...
            className="group inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium text-white bg-[linear-gradient(135deg,#ff7e40_0%,#ff4b72_50%,#a445ff_100%)] shadow-[0_4px_24px_rgba(164,69,255,0.25),inset_0_1px_0_rgba(255,255,255,0.2)] transition-all duration-200 hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_6px_32px_rgba(164,69,255,0.35)]"
        ...
        <p className="mt-8 text-[11px] text-[#3f3f46] tracking-wide">
