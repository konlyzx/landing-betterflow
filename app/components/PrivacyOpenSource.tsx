...
const LocalProcessingVisual = () => (
  <div className="w-full h-full flex items-center justify-center relative p-4">
    <div className="relative w-[180px] h-[120px] rounded-lg border border-white/[0.08] bg-[#0c0c0e] overflow-hidden">
      <div className="h-5 border-b border-white/[0.06] flex items-center gap-1.5 px-2">
        <div className="w-2 h-2 rounded-full bg-white/10" />
        <div className="w-2 h-2 rounded-full bg-white/10" />
        <div className="w-2 h-2 rounded-full bg-white/10" />
      </div>
      <div className="flex flex-col items-center justify-center h-[calc(100%-20px)] gap-2">
        <div className="w-10 h-10 rounded-full bg-[#c9d4ff]/10 border border-[#c9d4ff]/20 flex items-center justify-center">
          <Lock className="w-5 h-5 text-[#c9d4ff]" />
        </div>
        <span className="text-[9px] text-white/40 font-mono">localhost</span>
      </div>
      <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 180 120">
        <circle cx="90" cy="55" r="28" fill="none" stroke="rgba(201,212,255,0.1)" strokeWidth="1" strokeDasharray="4 4">
          <animateTransform attributeName="transform" type="rotate" from="0 90 55" to="360 90 55" dur="8s" repeatCount="indefinite" />
        </circle>
      </svg>
    </div>
    <div className="absolute -right-2 top-1/2 -translate-y-1/2">
      <div className="text-[9px] text-white/30 font-mono rotate-90">No Upload</div>
    </div>
  </div>
);
...
const ZeroTelemetryVisual = () => (
  <div className="w-full h-full flex items-center justify-center relative p-4">
    <div className="flex flex-col items-center gap-3">
      <div className="relative w-14 h-14 rounded-full bg-white/[0.03] border border-white/[0.08] flex items-center justify-center">
        <EyeOff className="w-6 h-6 text-[#71717a]" />
        <div className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-[#c9d4ff]/20 border border-[#c9d4ff]/30 flex items-center justify-center">
          <span className="text-[7px] text-[#c9d4ff] font-bold">0</span>
        </div>
      </div>
      <div className="flex gap-2">
        {["Cookie", "Pixel", "Beacon"].map((label, i) => (
          <div key={label} className="flex items-center gap-1 px-2 py-1 rounded bg-white/[0.03] border border-white/[0.06]">
            <span className="text-[8px] text-white/30 line-through font-mono">{label}</span>
          </div>
        ))}
      </div>
    </div>
...
const MITLicenseVisual = () => (
  <div className="w-full h-full flex items-center justify-center relative p-4">
    <div className="flex flex-col items-center gap-3">
      <div className="px-4 py-2 rounded-lg bg-[#c9d4ff]/10 border border-[#c9d4ff]/20">
        <span className="text-xs font-semibold text-[#c9d4ff] tracking-wider">APACHE 2.0</span>
      </div>
      <div className="w-full max-w-[140px] space-y-1.5">
        {[
          ...
          <div key={item.label} className="flex items-center gap-2">
            <span className="text-[8px] text-white/40 w-14 text-right font-mono">{item.label}</span>
            ...
            <svg className="w-3 h-3 text-[#c9d4ff]/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="M5 12l5 5L20 7"/></svg>
          </div>
        ))}
      </div>
    </div>
...
const CONTRIBUTION_INTENSITIES = [
  ...
  0.68, 0.38, 0.98, 0.02, 0.52, 0.26, 0.74,
];
  ...
  <div className="w-full h-full flex items-center justify-center relative p-4">
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="flex items-center gap-1.5 mt-1">
        ...
        <span className="text-[9px] text-white/30 font-mono">Open for contributions</span>
      </div>
    </div>
  </div>
);
...
const CodePreviewVisual = () => (
  <div className="w-full h-full flex items-center justify-center relative p-4">
    <div className="w-[190px] rounded-lg border border-white/[0.06] bg-[#0c0c0e] overflow-hidden font-mono text-[9px]">
      ...
      <div className="p-2.5 space-y-1">
        ...
        <div className="pl-3"><span className="text-white/60">privacy</span><span className="text-white/30">:</span> <span className="text-[#c9d4ff]">true</span><span className="text-white/30">,</span></div>
        <div className="pl-3"><span className="text-white/60">telemetry</span><span className="text-white/30">:</span> <span className="text-[#ff7e40]">false</span><span className="text-white/30">,</span></div>
        <div className="pl-3"><span className="text-white/60">localOnly</span><span className="text-white/30">:</span> <span className="text-[#c9d4ff]">true</span><span className="text-white/30">,</span></div>
  ...
  <div className="w-full h-full flex items-center justify-center relative p-4">
    <div className="flex flex-col gap-3 w-full max-w-[200px]">
      <div className="flex items-center justify-between">
        <span className="text-[9px] text-white/30 font-mono">TypeScript</span>
        <div className="flex-1 mx-2 h-1 rounded-full bg-white/[0.04]">
          <div className="h-full rounded-full bg-[#c9d4ff]/40" style={{ width: "85%" }} />
        </div>
        <span className="text-[9px] text-white/30 font-mono">85%</span>
      </div>
      <div className="flex items-center justify-between">
        <span className="text-[9px] text-white/30 font-mono">CSS</span>
        <div className="flex-1 mx-2 h-1 rounded-full bg-white/[0.04]">
          <div className="h-full rounded-full bg-[#f5d4e8]/40" style={{ width: "15%" }} />
        </div>
        <span className="text-[9px] text-white/30 font-mono">15%</span>
      </div>
...
export default function PrivacyOpenSource() {
  ...
  return (
    <section className="relative z-10 py-24 px-6" id="privacy">
      <div className="max-w-[1324px] mx-auto" ref={gridRef}>
        ...
        >
          <h2 style={{ fontFamily: "Geist, sans-serif", fontSize: "32px", fontWeight: 500, color: "#fff", letterSpacing: "-0.02em", margin: 0 }}>
            Privacy & Open Source
          </h2>
        </motion.div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-black font-regular text-sm bg-[linear-gradient(110deg,#c9d4ff_0%,#e0d4ff_45%,#f5d4e8_100%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.7),0_1px_2px_rgba(80,60,120,0.15)] transition-all hover:brightness-105"
          >
