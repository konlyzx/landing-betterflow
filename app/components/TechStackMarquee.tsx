...
function TechBadge({
  ...
  return (
    <motion.button
      ...
      className={`relative my-2 flex h-10 cursor-pointer items-center justify-center overflow-hidden rounded-lg select-none ${
...
export default function TechStackMarquee() {
  ...
  return (
    <>
      <section className="relative z-10 border border-white/10 bg-white/[0.01] px-6 py-8">
        <div className="mx-auto flex max-w-[1200px] flex-col items-center justify-between gap-6 md:flex-row md:gap-4">
          <div className="-ml-15 max-w-[280px] text-center text-xs leading-relaxed text-[#71717a] md:text-left">
          ...
          <div className="ml-15 max-w-[680px] flex-1 px-4 py-5">
            <Marquee
              isPaused={isPaused}
              speed={20}
              items={badges.map((b) => (
          ...
          >
            <div className="mx-auto max-w-[1200px] px-6 py-8">
              <motion.div
                ...
                className="relative rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 backdrop-blur-xl md:p-8"
              >
                <div className="flex flex-col gap-6 md:flex-row md:items-start">
                  <div className="flex-shrink-0">
                    ...
                    <motion.div
                      ...
                      className="mt-3 text-[10px] font-medium tracking-widest text-[#71717a] uppercase"
                    >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <motion.a
                      ...
                      className="mt-4 inline-flex items-center gap-1.5 text-xs text-[#c9d4ff] transition-colors hover:text-white"
                    >
                ...
                <button
                  ...
                  className="absolute top-4 right-4 flex h-7 w-7 cursor-pointer items-center justify-center rounded-full text-white/40 transition-all hover:bg-white/10 hover:text-white/80"
                >
