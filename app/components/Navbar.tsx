      ...
      >
        <motion.div
          ...
          animate={{
            ...
            backgroundColor: scrolled ? "rgba(11, 11, 12, 0.6)" : "rgba(11, 11, 12, 0)",
            backdropFilter: scrolled ? "blur(24px) saturate(1.4)" : "blur(0px)",
            borderColor: scrolled ? "rgba(255, 255, 255, 0.04)" : "rgba(255, 255, 255, 0)",
          }}
        ...
        >
            ...
            >
              ...
              {NAV_LINKS.map(({ label, href, external }) => (
                <a
                  ...
                  onClick={(e) => handleLinkClick(e, href, external)}
                >
                  {label}
                </a>
              ))}
          ...
          <div className="flex items-center gap-3">
            ...
            {/* <a
              ...
              className="hidden md:flex items-center gap-2 px-4 h-9 rounded-xl text-[13px] font-medium text-white bg-[#141416] border border-white/[0.08] hover:border-white/[0.15] transition-all duration-200"
            >
            ...
            {/* Twitter & GitHub icons (same as StudioPlayground) */}
            <a href="https://x.com/konlyzx_" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center justify-center w-8 h-8 rounded-lg transition-all text-white/50 hover:text-white">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://github.com/konlyzx/betterflow" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center justify-center w-8 h-8 rounded-lg transition-all text-white/50 hover:text-white">
            ...
            >
              {NAV_LINKS.map(({ label, href, external }) => (
                <a
                  ...
                  target={external ? "_blank" : undefined}
                  rel={external ? "noopener noreferrer" : undefined}
                  className="text-xl font-medium text-white/80 hover:text-white transition-colors uppercase tracking-wider"
                  onClick={(e) => {
                    if (!external) {
                      e.preventDefault();
                      setMenuOpen(false);
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 inline-flex items-center gap-2 px-6 py-3 rounded-xl text-black font-regular bg-[linear-gradient(110deg,#c9d4ff_0%,#e0d4ff_45%,#f5d4e8_100%)] shadow-[inset_0_1px_0_rgba(255,255,255,0.7),0_1px_2px_rgba(80,60,120,0.15)] transition-all hover:brightness-105"
              >
