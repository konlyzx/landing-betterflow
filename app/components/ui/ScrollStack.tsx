...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  return (
    <div
      ref={scrollerRef}
      className={`relative w-full ${useWindowScroll ? "" : "h-full overflow-x-visible overflow-y-auto"} ${className}`.trim()}
      style={{
    ...
    >
      <div className="scroll-stack-inner min-h-screen px-4 pt-[20vh] pb-[50rem] md:px-20">
        {children}
